...
class VictoryTextAnimation:
    """Typing effect for 'VICTORY' text"""
    ...
    def __init__(self) -> None:
        self.shared = Shared()
        self.text = ""
        self.eventual_text = list(reversed("VICTORY"))
...
class CauseTextAnimation:
    """Blinking effect for cause of victory"""
    ...
    def __init__(self) -> None:
        self.shared = Shared()
        self.surf = self.FONT.render("You killed the king!", True, self.TEXT_COLOR)
        self.timer = Time(0.5)
        self.show = True
        self.blinks = 0
...
class VictoryState:
    def __init__(self) -> None:
        ...
        self.overlay.fill((0, 150, 0))
        self.alpha = 0.0
        self.gota = VictoryTextAnimation()
